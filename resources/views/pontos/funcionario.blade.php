        ...
        <div class="card-body p-4">
            ...
            <div class="row mb-4">
                <div class="col text-center">
                    ...
                    <p class="text-muted fs-5">Gerencie os registros de ponto de <strong>{{ $funcionario->usuario->name ?? 'N/A' }}</strong></p>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('pontos.createEntrada', $funcionario->id) }}" class="btn btn-primary">
                    Registrar Entrada
                </a>
            </div>
